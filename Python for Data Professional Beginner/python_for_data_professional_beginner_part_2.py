...
print(parcel1)
print(parcel3)
# Fitur .isdisjoint() -> Mengembalikan nilai kebenaran apakah suatu set disjointdengan set lainnya.
...
print(parcel_C)
# Fitur .difference()-> Mengembalikan sebuah set yang berisikan difference dari dua set lainnya. 
